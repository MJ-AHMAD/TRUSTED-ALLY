    ...
    <div className="bg-primary">
      <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          <span className="block">Ready to TrustedAlly your workflow?</span>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Join thousands of satisfied customers who have transformed their business with TrustedAlly.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
