...
const testimonials = [
  {
    ...
    quote:
      "TrustedAlly has revolutionized our workflow. It's intuitive, powerful, and has significantly boosted our team's productivity.",
  },
  {
    name: "John Davis",
    ...
    image: "/placeholder.svg?height=400&width=400",
    quote:
      "The analytics features in TrustedAlly have provided us with invaluable insights. It's been a game-changer for our marketing strategies.",
  },
  {
    name: "Emily Chen",
    ...
    image: "/placeholder.svg?height=400&width=400",
    quote:
      "The collaboration tools in TrustedAlly have made remote work seamless for our team. It's an essential part of our daily operations now.",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-xl text-muted-foreground">
            Here's what our satisfied customers have to say about TrustedAlly
          </p>
        </motion.div>
