      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:text-center">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Everything you need to TrustedAlly your workflow
          </motion.p>
          <motion.p
            ...
            viewport={{ once: true }}
          >
            TrustedAlly offers a comprehensive set of features designed to boost your productivity and simplify your
            business processes.
          </motion.p>
        </div>
