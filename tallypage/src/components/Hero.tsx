    ...
    <div className="bg-background py-20 md:py-32 overflow-hidden relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            TRUSTED-ALLY believes that a better and enlightened society can be built through education. We dedicate all
            our resources and activities to achieving this goal.
          </motion.p>
          <motion.div
